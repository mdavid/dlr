...
namespace IronRuby.StandardLibrary.Yaml {
    public sealed class YamlLibraryInitializer : IronRuby.Builtins.LibraryInitializer {
        protected override void LoadModules() {
            ...
            ExtendModule(typeof(Microsoft.Scripting.DynamicNull), new Action<IronRuby.Builtins.RubyModule>(LoadSystem__Dynamic__DynamicNull_Instance), null, IronRuby.Builtins.RubyModule.EmptyArray);
            ...
            IronRuby.Builtins.RubyModule def1 = DefineGlobalModule("YAML", typeof(IronRuby.StandardLibrary.Yaml.RubyYaml), true, null, new Action<IronRuby.Builtins.RubyModule>(LoadYAML_Class), IronRuby.Builtins.RubyModule.EmptyArray);
            IronRuby.Builtins.RubyClass def2 = DefineClass("YAML::Stream", typeof(IronRuby.StandardLibrary.Yaml.RubyYaml.YamlStream), true, classRef0, new Action<IronRuby.Builtins.RubyModule>(LoadYAML__Stream_Instance), null, IronRuby.Builtins.RubyModule.EmptyArray, new System.Delegate[] {
        ...
        private void LoadSystem__Object_Instance(IronRuby.Builtins.RubyModule/*!*/ module) {
            ...
            module.DefineLibraryMethod("to_yaml_properties", 0x11, new System.Delegate[] {
                new Func<IronRuby.Runtime.BinaryOpStorage, IronRuby.Runtime.BinaryOpStorage, IronRuby.Runtime.BinaryOpStorage, IronRuby.Runtime.RubyContext, System.Object, IronRuby.Builtins.RubyArray>(IronRuby.StandardLibrary.Yaml.YamlObjectOps.ToYamlProperties),
            });
